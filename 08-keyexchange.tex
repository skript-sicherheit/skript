...
Im nächsten Schritt schickt der Server dem Client seinen öffentlichen Schlüssel sowie das dazugehörige Zertifikat, damit der Client die Identität seines
...
Nun berechnet der Client eine weitere Zufallszahl, das so genannte \emph{premaster secret}, und schickt es verschlüsselt mit dem
...
Kommunikationspartners und das \textit{premaster secret}. Aus diesen drei Zufallszahlen berechnen Client und Server nun mithilfe eines öffentlich bekannten
