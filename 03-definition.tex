...
\begin{definition}[IND-CPA-Sicherheit]
	...
	\end{enumerate}
	Ein Verfahren heißt IND-CPA-sicher, wenn der Vorteil des PPT-Angreifers gegenüber dem Raten einer Lösung, also $\Pr \left[ \A \textnormal{ gewinnt} \right] - \frac{1}{2}$, für alle PPT-Angreifer $\A$ vernachlässigbar ist. 
\end{definition}
...
\begin{definition}[IND-CCA-Sicherheit]
	...
	\begin{enumerate}
		...
		\item $\A$ gewinnt, wenn er $b$ korrekt errät
	\end{enumerate}
	Ein Verfahren heißt IND-CCA-sicher, wenn der Vorteil des PPT-Angreifers gegenüber dem Raten einer Lösung, also $\Pr \left[\A \textnormal{ gewinnt} \right] - \frac{1}{2}$, für alle PPT-Angreifer $\A$ vernachlässigbar ist. 
\end{definition}
\begin{figure}[h]
	\centering
	%\scalebox{0.8}{
