...
\newcommand{\indexComputationalDiffieHellmanAssumption}{\index{Computational Diffie-Hellman-Annahme (CDH-Annahme)}}
\newcommand{\indexComputationalDiffieHellmanProblem}{\index{Computational Diffie-Hellman-Problem (CDH-Problem)}}
...
%Kapitel 9
\newcommand{\indexPKIdentificationProtocol}{\index{Public-Key-(PK-)Identifikationsprotokoll}}
...
%Kapitel 12
\newcommand{\indexAccessControl}{\index{Zugriffskontrolle}}
\newcommand{\indexBellLaPadula}{\index{Zugriffskontrolle!Bell-LaPadula-Modell}\index{Bell-LaPadula-Modell}}
\newcommand{\indexBLPSystemStatus}{\index{Bell-LaPadula-Modell!Systemzustand}}
\newcommand{\indexBLPDiscretionarySecurity}{\index{Bell-LaPadula-Modell!Discretionary-Security (ds-Eigenschaft)}}
\newcommand{\indexBLPSimpleSecurity}{\index{Bell-LaPadula-Modell!Simple-Security (ss-Eigenschaft)}}
\newcommand{\indexBLPStarProperty}{\index{Bell-LaPadula-Modell!Star-Property ($\star$-Eigenschaft)}}

\newcommand{\indexChineseWall}{\index{Zugriffskontrolle!Chinese-Wall-Modell}\index{Chinese-Wall-Modell}}
\newcommand{\indexCWSimpleSecurity}{\index{Chinese-Wall-Modell!Simple-Security (ss-Eigenschaft)}}
\newcommand{\indexCWStarProperty}{\index{Chinese-Wall-Modell!Star-Property ($\star$-Eigenschaft)}}
