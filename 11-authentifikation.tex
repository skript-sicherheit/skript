...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{l||c|c|c|c} & \multicolumn{2}{c|}{Eve} &
\multicolumn{2}{|c}{Mallory}\\ & lernt $\pw$ & Anmelden als $U$ & lernt
$\pw$ & Anmelden als $U$ \\\hline\hline Verfahren 1
(Abb. \ref{fig:auth:simplepassword}) & X & X & X & X \\\hline Verfahren
...
stimmt, berechnet der Angreifer daher $H(f(H(\pw^*)))$ und sucht in
...
\begin{figure}[h] %complete results: % a =>
...
\hasharrow H(\pw_2) \VRTF[2] %\pw_3 \quad \ldots \quad \hasharrow
...
a & 86f7 & p & 516b & j & 5c2d & r & 4dc7\\ b & e9d7 & j & 5c2d & q &
22ea & l & 07c3\\ c & 84a5 & x & 11f6 & u & 51e6 & j & 5c2d\\ d & 3c36 &
d & 3c36 & e & 58e6 & y & 95cb\\ e & 58e6 & w & aff0 & s & a0f1 & g &
54fd\\ f & 4a0a & k & 13fb & q & 22ea & l & 07c3\\ g & 54fd & m & 6b0d &
m & 6b0d & n & d185\\
	\end{tabular}
...
\end{center}
\end{figure} Man sieht, dass die Hashketten "`b"' und "`f"'
...
\begin{beispiel} Wir verwenden die Hashketten aus Abbildung
...
$i$ sein soll.  Man berechnet $f_{m-2}(H(\pw^*)) = u$,
$H(f_{m-2}(H(\pw^*))) = 51e6\cdots$, $f_{m-1}(H(f_{m-2}(H(\pw^*)))) = j$
und $H(f_{m-1}(H(f_{m-2}(H(\pw^*))))) = 5c2d\cdots$. Diesmal liefert die
...
sondern $H(H(\ldots H(\pw)\ldots))$. Wiederholt man die Funktion $H$
