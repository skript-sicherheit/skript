...
Schema wäre. Somit kann \A~nur in $k$ vernachlässigbare
...
\begin{definition}[Pseudorandomisierte Funktion (PRF)] Sei\\
  ...
  \end{equation*} vernachlässigbar $k$ ist, wobei $R: \{0,1\}^k \rightarrow
...
\begin{beweis}[Entwurf] Sei $\mathcal{A}$ ein erfolgreicher
  ...
  \textit{PRF} jedoch nach Definition nur mit $k$ vernachlässigbarer
