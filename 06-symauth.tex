...
Ein MAC (\sig, \ver) ist \textit{EUF\footnote{\textit{EUF} steht für
    ...
    sich vom Orakel signiren lässt. Insbesondere darf er seine Anfragen
    von bereits erhaltenen $\plaint_i$, $\sigma_i$ abhängig machen.}-sicher},falls jeder
...
beliebiger Länge signieren. Hierzu bieten sich Hash-Funktionen an, die
