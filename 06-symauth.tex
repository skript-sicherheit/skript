...
Verifikationsalgorithmus. Beide Algorithmen sind PPT-Algoritmen und
...
\begin{beweisidee}
  ...
  \plaint~fälschen. Dies steht aber im Widerspruch zur vorrausgesetzen
  ...
  $(\sig,\ver)$ folg aber direkt, dass dafür $H(\plaint') = H(\plaint^*)$
