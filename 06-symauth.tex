...
Einen Signaturalgorithmus, der sicherstellt, dass jeder beliebige PPT-Angreifer $\mathcal{A}$ dieses Spiel nur vernachlässigbar oft gewinnt, nennen wir \textit{EUF-CMA-sicher} (EUF:Existential Unforgeability, CMA: Chosen Message Attack).
