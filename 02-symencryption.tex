...
Zustand $K^{(i)} \in \{0,1\}^k, i \leq n$, der initial auf den Schlüsselwert $K$ gesetzt wird und eine Funktion
\begin{align*}
	SC(K^{(i)}) \in \{0,1\} \times \{0,1\}^k\, ,
\end{align*}
die den Zustand aktualisiert und die zur Verschlüsselung notwendigen Bits erzeugt.
