...
sind diese nicht praktikabel. Problematisch ist allerdings der mit 56 Bit recht kleine Schlüsselraum (8 der 64 Schlüsselbits sind Paritätsbits). Im Jahr 2008 konstruierte die Firma \emph{SciEngines GmbH} einen Computer, der innerhalb eines Tages den gesamten Schlüsselraum durchsucht. %TODO Produktionskosten? (Inoffiziell: ~ 20000 €)
...
Für die Verschlüsselung greift AES also auf Operationen zurück, die man in ihrer Ganzheit treffend als Substitutions- und Rotationsnertzwerk beschreiben kann. Wir sehen, dass S-Boxen nicht nur in der Feistel-Struktur Verwendung finden und sehr wohl auch bijektiv seien können.
