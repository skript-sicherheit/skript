...
\subsubsection{Cipher Block Chaining Mode (CBC-Modus)}\label{sssec:cbc}
...
\subsubsection{Counter Mode (CTR-Modus)}\label{sssec:ctr}
...
\subsubsection{Authentifizerte Betriebsmodi}\label{sssec:gcm}
