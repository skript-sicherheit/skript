...
\begin{beispiel}
	Seien $(\plaint, \sigma)$ und $(\plaint',\sigma')$ zwei Klartext-Signatur-Paare und gelte weiterhin $\plaint' = (\plaint_{1}',\plaint_{2}',\dots,\plaint_{n}') \neq \plaint$. Beide Paare seien einem Angreifer bekannt. Dieser kann nun eine Nachricht 
