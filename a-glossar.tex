...
\begin{tabularx}{\textwidth}{ p{.12\textwidth} | X }
	...
	$NPC$ & $NPC$ ist die Menge der Sprachen $L \in NP$, für die zusätzlich gilt: ${\forall L' \in NP : L' \leq L}$, die d.h. es existiert eine Turing-Maschine,
	$L'$ auf $L$ in Polynomialzeit reduziert (Alternativ: $NP\text{-complete}$, $NP\text{-vollständig}$)\\
\end{tabularx}
