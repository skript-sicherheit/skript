...
Es bietet sich ein Verfahren an, bei dem die Prüfung einer Signatur nicht mit einem privaten Schlüssel erfolgt. Dieses System kennen wir bereits aus dem Kapitel
...
Auch hier führt uns also nicht sofort der intuitive Ansatz zu einem sicheren Signaturverfahren. Stattdessen wählt Alice, die eine Nachricht
...
\begin{description}
	...
	\end{align*}
	Mit bekanntem $e$ kann also wiederum auf den geheimen Schlüssel $x$ geschlossen werden. Bei zufälliger Wahl geschieht es nur vernachlässigbar
	oft, dass zwei Mal dasselbe $e$ ausgewählt wird und infolgedessen ausgenutzt werden kann.
...
nicht mehr vollständige Nachrichten durch den Signaturalgorithmus geschickt werden, sondern nur noch vergleichsweise kurze Hashwerte. Die Sicherheit eines
solchen Schemas sichert das folgende Theorem.~\\
