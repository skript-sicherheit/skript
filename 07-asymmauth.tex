\chapter{Asymmetrische Authentifikation von Nachrichten}\indexMessageAuthAsymm
\label{cha:asymmauth}
...
\begin{description}
  ...
  \item[Homomorphie von RSA:]\indexRSAHomomorphie Angenommen, ein Angreifer ist im Besitz
  ...
  \end{beispiel}
Wie bereits bei der RSA-Verschlüsselung in Kapitel \ref{ch:asymmenc:rsa:sicherheit} können wir diese Probleme lösen, indem wir die Nachricht vor der Verarbeitung padden:\indexRSAPSS
\begin{align*}
...
\section{ElGamal}
Analog zum ElGamal-Verschlüsselungssystem \indexElGamal aus Kapitel
...
\section{Digital Signature Algorithm (DSA)}\indexDSA
...
\section{Digitale Zertifikate}\indexDigitalCert
...
sog. \emph{Certificate Authority (CA)} \indexCertAuthority ausgestellt. Überlicherweise
...
Institution gehört. Dafür muss man jedoch zum einen der CA \indexCertAuthority trauen, zum
...
\subsection{X.509}\indexXFiveZeroNine
