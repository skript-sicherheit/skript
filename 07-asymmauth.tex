...
\end{equation*}
\subsection{Asymmetrische EUF-CMA-Sicherheit}
...
\begin{definition}
Sei \A~ein PPT-Algorithmus und \C~der Herrausforderer.
\begin{enumerate}
\item \C~generiert mit dem Generator-Algorithmus ein Schlüsselpaar, d.h. er berechnet $(\pkey, \skey) \leftarrow \gen(1^k)$.
