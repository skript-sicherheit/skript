...
\item[Homomorphie:] Auf der multiplikativen Gruppe $(\mathbbm{Z}, \cdot)$ des RSA-Modulus gilt der Zusammenhang
  ...
  Folgendes Beispiel soll veranschaulichen, zu welchen Zwecken die Homomorphie verwendet werden kann:   
    \begin{beispiel}
    	...
    	bzw. knapp überbieten, ohne dass der Auktionator oder der ehrliche Bieter $B_1$ ihm den Betrug nachweisen können.
    \end{beispiel}
\end{description} 
