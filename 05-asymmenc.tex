...
\begin{beispiel}[EEA]
	...
	\end{align*}
	jeweils $f_i$ und $R_i$, bis $R_i = 0$. Dabei ist $A_{i+1} = B_i$ und $B_{i+1} = R_i$. Parallel dazu entwickeln wir die Parameter $s$ und $t$ \emph{vorwärts}.
	\begin{table}[h]
		\centering
		\begin{tabular}[c]{c|l|ccc|l}
